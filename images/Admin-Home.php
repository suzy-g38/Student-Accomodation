          ...
          $data = json_decode($data, true);
            ...
            ?>
              ...
              <div class="update-room hideform">
                <button class="btn btn-light admin-close">X</button>
                <form class="form-body update-room-form" action="Admin-Home.php" method="post">
                  <div class="form-group ">
                    <p class="update-room-para">UPDATE ROOM</p>
                    <input type="number" name="update_room_id" class="form-control" id="update_room-id" placeholder="Room ID">
                  </div>
                  <div class="form-group">
                    <input type="text" name="update_room_type" class="form-control" id="update_room-type" placeholder="Room Type">
                  </div>
                  <div class="form-group">
                    <input type="text" name="update_room_location" class="form-control" id="update_room-location" placeholder="Room Location">
                  </div>
                  <div class="form-group">
                    <input type="number" name="update_room_charge" class="form-control" id="update_room-charge" placeholder="Room Charge">
                  </div>
                  <div class="form-group">
